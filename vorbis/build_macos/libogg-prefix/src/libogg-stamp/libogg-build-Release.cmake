...
set(stdout_log "/Users/ljh/音频编码算法研究/源码/compileScript/vorbis/build_macos/libogg-prefix/src/libogg-stamp/libogg-build-out.log")
set(stderr_log "/Users/ljh/音频编码算法研究/源码/compileScript/vorbis/build_macos/libogg-prefix/src/libogg-stamp/libogg-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /Users/ljh/音频编码算法研究/源码/compileScript/vorbis/build_macos/libogg-prefix/src/libogg-stamp/libogg-build-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "libogg build command succeeded.  See also /Users/ljh/音频编码算法研究/源码/compileScript/vorbis/build_macos/libogg-prefix/src/libogg-stamp/libogg-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
