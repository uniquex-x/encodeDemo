...
set(stdout_log "/Users/ljh/音频编码算法研究/源码/compileScript/vorbis/build_macos/libvorbis-prefix/src/libvorbis-stamp/libvorbis-install-out.log")
set(stderr_log "/Users/ljh/音频编码算法研究/源码/compileScript/vorbis/build_macos/libvorbis-prefix/src/libvorbis-stamp/libvorbis-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /Users/ljh/音频编码算法研究/源码/compileScript/vorbis/build_macos/libvorbis-prefix/src/libvorbis-stamp/libvorbis-install-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "libvorbis install command succeeded.  See also /Users/ljh/音频编码算法研究/源码/compileScript/vorbis/build_macos/libvorbis-prefix/src/libvorbis-stamp/libvorbis-install-*.log")
    message(STATUS "${msg}")
  endif()
endif()
